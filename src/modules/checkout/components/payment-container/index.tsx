...
const PaymentContainer: React.FC<PaymentContainerProps> = ({
  ...
  return (
    <RadioGroupOption
      ...
      disabled={disabled}
      className={clx(
        'flex flex-col gap-y-2 text-small-regular cursor-pointer py-4 border rounded-rounded px-8 mb-2 hover:border-pika-100',
        {
          'border-pika-100': selectedPaymentOptionId === paymentProviderId,
        }
      )}
    >
